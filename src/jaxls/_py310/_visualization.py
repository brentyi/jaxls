...
def _get_cost_color(kind: Any) -> Any:
    colors = {
...
def _get_var_color(var_type_name: Any, var_type_index: Any) -> Any:
...
def _count_total_costs(problem: Any) -> Any:
    import numpy as onp
...
def _count_total_variables(problem: Any) -> Any:
    import numpy as onp
